...
extern void *mono_aot_module_FinancialAnalysis_info;
...
{
	mono_aot_register_module (mono_aot_module_FinancialAnalysis_info);
...
void xamarin_setup_impl ()
{
	...
	xamarin_executable_name = "FinancialAnalysis.dll";
	mono_use_llvm = FALSE;
	xamarin_log_level = 0;
